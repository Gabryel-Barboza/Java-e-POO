...
public class TelaFuncao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cálculo Fatorial 2.0");
    ...
    private void spnNumStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_spnNumStateChanged
        ...
        fat.setValor(Integer.parseInt(spnNum.getValue().toString())); //Pegar valor spinner
        lblRes.setText(fat.getFormula() + fat.getFatorial()); //Setar texto com resultado
