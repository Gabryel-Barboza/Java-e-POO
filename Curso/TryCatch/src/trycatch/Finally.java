...
public class Finally {
    ...
    public static void main(String[] args) {
        //O bloco Finally é executado sempre após o tratamento de erros
        //Útil para quando trabalhar com arquivos, caso ocorra o erro, esse erro é tratado e logo após
